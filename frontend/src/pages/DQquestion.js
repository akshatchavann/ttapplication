...
const DQquestion = () => {
    ...
    useEffect(() => {
        const fetchQuestionData = async () => {
            try {
                const response = await fetch(`https://ttapplication-backend.vercel.app/api/dailyquestions/${id}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`https://ttapplication-backend.vercel.app/api/dailyquestions/update/${id}`, {
                method: 'PUT',
                headers: {
